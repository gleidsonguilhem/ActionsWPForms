                    ...
                    <table class="table table-striped table-borderless">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="25%"><button type="submit" id="atualizarsubmit" name="atualizarsubmit" class="btn btn-success btn-sm">UPDATE </button> <a href="<?php echo $PAGE_NAME ?>.php"><button type="button" class="btn btn-light btn-sm">Cancelar</button></a></td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //END SCRIPT
        function sendEmail(edit_id) {
            Email.send({
                    Host: "smtp.gmail.com",
                    Username: "toastackit.com",
                    Password: "",
                    To: "gleidson.guilhem@gmail.com",
                    From: "toastackit@gmail.com",
                    Subject: "Aprovacao solicitada",
                    Body: "nome Aprovar Solicitacao para",
                })
                .then(
